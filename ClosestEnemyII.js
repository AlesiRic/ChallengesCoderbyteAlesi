function ClosestEnemyII(strArr) {
    ...
    var res = strArr.length * strArr[0].length;
    for (var row = 0, len = strArr[0].length; row < len; row++) {
...
module.exports.enemigoCercano=ClosestEnemyII;